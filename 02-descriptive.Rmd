...
Here is the deal. These outputs are very long consumes time to read it all. But, I strongly recommend creating and reading these reports. If you go somewhere as delegate and your task is to writing a report over monitoring survey data, this exercise allows you to feel the data, all variables and their distributions. Spending an hour will make you to have way more efficient data analysis step.

```{r,error=FALSE,echo=FALSE,warning=FALSE}
#ExpReport(xEDA, op_file = 'smarteda.html')
#diagnose_report(xEDA)
colnames(diamonds)
library(dlookr)
diamonds %>%
  eda_report(
