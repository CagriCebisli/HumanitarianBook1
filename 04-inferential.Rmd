...
pdmbt2 <- pdmbt %>% dplyr::select(incomebinarylog,LCSI,rCSI,x_total,Coverage_Needs_TL,x_food30days_total,x_rent,num_IndividualinHH)

#Logistic Regression model, same inputs as linear model.

model <- glm(incomebinarylog~LCSI+rCSI+x_total+Coverage_Needs_TL+x_food30days_total+x_rent+num_IndividualinHH, 
               data = pdmbt2, 
               family = binomial)
