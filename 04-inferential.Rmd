...
pdmbt2 <- pdmbt %>% select(incomebinarylog,LCSI,rCSI,FCG,x_total,Coverage_Needs_TL,x_food30days_total,x_rent,num_IndividualinHH)

#Logistic Regression model, same inputs as linear model.

model <- glm(incomebinarylog~LCSI+rCSI+FCG+x_total+Coverage_Needs_TL+x_food30days_total+x_rent+num_IndividualinHH, 
               data = pdmbt, 
               family = binomial)
...
predictors <- c("incomebinarylog","LCSI","rCSI","FCG","x_total","Coverage_Needs_TL","x_food30days_total",
                "x_rent","num_IndividualinHH")
